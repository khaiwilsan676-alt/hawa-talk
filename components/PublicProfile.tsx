          ...
          {albumImages.length > 0 ? (
            <div className="grid grid-cols-2 gap-2">
              {albumImages.map((img, index) => (
                <div key={index} className="w-full h-28 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="relative bg-white w-full max-w-md rounded-t-3xl animate-slide-up flex flex-col h-[70vh]">
            ...
            <div className="overflow-y-auto px-5 py-4 space-y-5 flex-1 pb-24">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  onClick={() => albumInputRef.current?.click()}
                  className="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors border-2 border-dashed border-gray-300"
                >
