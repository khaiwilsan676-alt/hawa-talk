...
export default function Wildparty({ onClose }: WildpartyProps) {
  ...
  const animals: AnimalItem[] = [
    ...
    { id: 0, src: '/IMG_20260822_011118.png', alt: 'Dog', angle: 260, distance: 130, x: 8, y: -5, size: 55, multiplier: 5 },
    { id: 1, src: '/IMG_20260822_011134.png', alt: 'Deer', angle: 315, distance: 130, x: -4, y: -13, size: 72, multiplier: 5 },
