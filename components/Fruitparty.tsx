...
// -------------------------------------------------------------
const GRID_ITEMS = [
  { id: 1, type: 'fruit', img: '/IMG_20260908_192143.png', multi: '×5',  move: 'translate-x-[5px] -translate-y-[20px]',  imgW: 50, imgH: 50 },  // Lemon (Upar)
  { id: 2, type: 'fruit', img: '/IMG_20260908_192050.png', multi: '×10', move: '-translate-y-[20px]',                    imgW: 50, imgH: 50 },  // Apple (Upar)
  { id: 3, type: 'fruit', img: '/IMG_20260908_191941.png', multi: '×5',  move: '-translate-x-[5px] -translate-y-[20px]', imgW: 58, imgH: 58 },  // Mango (Upar)
  ...
  { id: 5, type: 'fruit', img: '/IMG_20260908_192120.png', multi: '×25', move: 'translate-y-[20px]',                     imgW: 50, imgH: 50 },  // Grapes (Neeche)
  { id: 6, type: 'fruit', img: '/IMG_20260908_192203.png', multi: '×5',  move: '-translate-x-[5px] translate-y-[20px]', imgW: 55, imgH: 55 },  // Orange (Neeche)
];
