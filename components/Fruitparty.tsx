...
// -------------------------------------------------------------
const FRUITS_CONFIG = [
  { id: 1, img: '/IMG_20260907_154053.png', x: 1.5,  y: 0,      w: 32, h: 32 }, // Lemon (right shift)
  { id: 2, img: '/IMG_20260907_154205.png', x: 32.333, y: 0,      w: 32, h: 32 }, // Guava (same)
  { id: 3, img: '/IMG_20260907_154232.png', x: 64.166, y: -1,  w: 35, h: 35 }, // Mango (left shift + very little upar)
  { id: 4, img: '/IMG_20260907_154250.png', x: 64.166, y: 31.333, w: 34.5, h: 34.5 }, // Orange (left shift + 1 more gap upar)
  ...
  { id: 8, img: '/IMG_20260907_154449.png', x: 1.5,  y: 31.333, w: 32, h: 32 }, // Cherry (right shift + 1 more gap upar)
];
