...
// -------------------------------------------------------------
 const FRUITS_CONFIG = [
  ...
  { id: 4, img: '/IMG_20260907_154250.png', x: 64.166, y: 33.333, w: 34, h: 34 }, // Orange (left shift)
  { id: 5, img: '/IMG_20260907_154323.png', x: 64.166, y: 66.666, w: 32.5, h: 32.5 }, // Grapesh (left shift)
  { id: 6, img: '/IMG_20260907_154348.png', x: 33.333, y: 66.666, w: 32.5, h: 32.5 }, // Strawberry (same)
  { id: 7, img: '/IMG_20260907_154417.png', x: 2.5,  y: 66.666, w: 32, h: 32 }, // Apple (right shift)
  { id: 8, img: '/IMG_20260907_154449.png', x: 2.5,  y: 33.333, w: 32, h: 32 }, // Cherry (right shift)
];
